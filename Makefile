...
OBJECTS =  main.o Display.o Simulator.o engine.o Player.o Enemy.o Single.o Versus.o Laser.o
...
engine.o : engine.h Simulator.h Sprite.h Root.h Versus.h Single.h
